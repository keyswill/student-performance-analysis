...
This document explains the grain of each dataset, how the tables relate, which fields answer the business questions, and where the data limits interpretation.
