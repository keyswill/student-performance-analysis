...
This phase defines the school decision the analysis supports, the intended users, the measures needed, and the limits of what the synthetic data can establish.
